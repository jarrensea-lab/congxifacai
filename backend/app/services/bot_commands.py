...
from app.services.trade_executor import update_account, execute_buy, execute_sell, execute_clear
...
def _process(db: Session, text: str) -> Dict[str, Any]:
    ...
    if total_match and cash_match:
        ...
        return update_account(db, total, cash)
    ...
    if buy_match:
        ...
        return execute_buy(db, code, name, qty, cost)
    ...
    if sell_match:
        ...
        return execute_sell(db, code, name, qty, price)
    ...
    if clear_match:
        ...
        return execute_clear(db, code, name)
