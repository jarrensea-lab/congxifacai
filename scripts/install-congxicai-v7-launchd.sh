...
export CONGXI_YITAOJIN_ENABLED="${CONGXI_YITAOJIN_ENABLED:-false}"
export CONGXI_YITAOJIN_WRITE_ENABLED="${CONGXI_YITAOJIN_WRITE_ENABLED:-false}"
export CONGXI_YITAOJIN_ACCOUNT_WRITE_ENABLED="${CONGXI_YITAOJIN_ACCOUNT_WRITE_ENABLED:-false}"
export CONGXI_YITAOJIN_WATCHLIST_WRITE_ENABLED="${CONGXI_YITAOJIN_WATCHLIST_WRITE_ENABLED:-false}"
export CONGXI_YITAOJIN_APP_PATH="${CONGXI_YITAOJIN_APP_PATH:-/Applications/GF-Trader.app}"
export CONGXI_YITAOJIN_BRIDGE_PATH="${CONGXI_YITAOJIN_BRIDGE_PATH:-${CONGXI_STATE_DIR}/bin/yitaojin-bridge}"
